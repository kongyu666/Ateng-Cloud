package io.github.kongyu666.common.log.aspect;
...
import io.github.kongyu666.common.core.enums.BusinessStatus;
import io.github.kongyu666.common.core.utils.JsonUtils;
import io.github.kongyu666.common.core.utils.ServletUtils;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            // *========数据库日志=========*//
            LogOperateEvent operLog = new LogOperateEvent();
            // 设置用户信息
            LoginUser userInfo;
            try {
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, LogOperateEvent operLog, Object jsonResult) throws Exception {
        // 设置action动作
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, LogOperateEvent operLog, String[] excludeParamNames) throws Exception {
